...
export default function SignUpPage() {
    ...
    const passwordStrength = (() => {
        ...
        if (score <= 1) return { label: "Weak", color: "text-orange-400", bar: "bg-orange-400", width: "w-2/4" };
        if (score <= 2) return { label: "Good", color: "text-yellow-400", bar: "bg-yellow-400", width: "w-3/4" };
        return { label: "Strong", color: "text-green-400", bar: "bg-green-400", width: "w-full" };
    })();
                            ...
                            <div className="p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-xs">
                                ...
                                {useGoogle && (
                                    <a
                                        ...
                                        className="mt-2.5 w-full py-2 rounded-lg border border-border bg-background text-sm font-medium text-foreground hover:border-foreground/30 transition-all flex items-center justify-center gap-2"
                                    >
