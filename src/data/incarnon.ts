...
export const incarnonWeaponData: IncarnonWeaponData[] = [
  ...
  // Laetum (native)
  {
    ...
    evolutions: [
      ...
      { tier: 5, slot: 0, name: "Devouring Attrition", description: "50% chance to deal +2000% Damage on non-critical hits.", statChanges: {} },
      { tier: 5, slot: 1, name: "Reaper's Plenty", description: "On Headshot: +40% Ammo Efficiency for 8s.", statChanges: {} },
      { tier: 5, slot: 2, name: "Overwhelming Attrition", description: "On Hit that is neither Critical nor Status: +400% Damage for 20s. Stacks up to 3x.", statChanges: {} },
    ],
  },
  // Phenmor (native)
  {
