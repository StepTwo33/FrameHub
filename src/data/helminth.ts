...
const subsumedAbilities: HelminthAbility[] = [
  ...
  { id: "subsume_sirius_orion", name: "Jade Stars", description: "Conjure Jade Light motes that regenerate over time; attacking enemies launches them for Heat damage.", energyCost: 50, source: "sirius_orion", sourceWarframe: "Sirius & Orion", abilitySlot: 2, duration: 20, radius: 4, damage: 350 },
