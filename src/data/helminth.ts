...
const subsumedAbilities: HelminthAbility[] = [
  ...
  { id: "subsume_jade", name: "Glory on High", description: "Ascend and rain down projectiles on enemies below.", energyCost: 50, source: "jade", sourceWarframe: "Jade", abilitySlot: 2, damage: 500 },
