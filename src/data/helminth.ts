...
const subsumedAbilities: HelminthAbility[] = [
  ...
  { id: "subsume_gyre", name: "Cathode Grace", description: "Gain a brief burst of increased Critical Chance and Energy Regen, with each kill extending duration of Cathode Grace. Casting is on a cooldown.", energyCost: 50, source: "gyre", sourceWarframe: "Gyre", abilitySlot: 3, duration: 15 },
  ...
  { id: "subsume_lavos", name: "Vial Rush", description: "Dash forward leaving a trail of damaging liquid.", energyCost: 0, source: "lavos", sourceWarframe: "Lavos", abilitySlot: 2, damage: 250 },
  ...
  { id: "subsume_voruna", name: "Shroud of Dynar", description: "Become invisible and gain energy on melee kills.", energyCost: 50, source: "voruna", sourceWarframe: "Voruna", abilitySlot: 1, duration: 18 },
